...
## Variation by artefact size and raw material
=======
## Variation in TCSA values by artefact size 
>>>>>>> 7d2e5999078052d316d352eb9227872e0fb13080
...
```{r}
  ...
  #            aes(long_dd ,
  #                lat_dd),
  #            colour = "red", <== change color for tcsa values
  #            size = 2) +
  # geom_text_repel(data = korean_archaeological_site_locations,
  #                 aes(long_dd ,
  #                     lat_dd,
...
tcsa_site_ass_mis <- tcsa_site_ass %>% 
                      mutate(mis_stage = case_when (age_ka > 29 ~ '3', age_ka < 29 ~ '2'))
