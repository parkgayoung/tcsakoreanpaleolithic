...
ggplot() +
  geom_sf(data = veg_forest, aes(fill = veg_forest$Zone)) + #add color for vegetation polygons
  geom_sf(data = pts_forest, aes(color = pts_forest$min_tcsa)) +
  theme_minimal()

ggplot(points_in_veg_zones_forest) +
  aes(Zone,
      min_tcsa) +
  geom_boxplot() +
  geom_quasirandom()

summary(aov(min_tcsa ~ as.factor(Zone), points_in_veg_zones_forest))
