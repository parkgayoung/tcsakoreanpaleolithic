...
#   tcsa_site_ass %>% 
#   mutate(Site_name = str_remove(Assemblage, "_.*")) %>%  
#   full_join(korean_archaeological_site_locations) %>% 
#   drop_na(min_tcsa)
  

korean_archaeological_site_locations_tcsa <- tcsa %>% 
  full_join(korean_archaeological_site_locations) %>% 
  drop_na(min_tcsa)
...
shapename <- read_sf(here("analysis/data/vegetationline.shp"))
