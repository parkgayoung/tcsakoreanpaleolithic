...
eco_aov <- aov(min_tcsa ~ as.factor(ecoregion), points_in_veg_zones_all)
summary(eco_aov)
...
\<--! In discussion we then compare those temporal patterns with demographic and environmental proxies based on summed probability distributions (SPD) and annual temperature changes from @park2022did. --\>
