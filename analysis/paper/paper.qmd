...
summary(aov(min_tcsa ~ as.factor(mis_stage), tcsa_site_ass_mis))
...
- Unclear pattern, but mainly made before LGM
- Function is not closely related to the period based on p-value but before LGM show wide variation. 
 - some assemblages show wide variation while the other show narrow variation.
