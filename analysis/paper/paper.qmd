...
```{r}
# ADD CODE TO REPLACE NULL WITH ACTUAL VALUES
n_sites <- NULL # replace this with the number
min_n_points <- NULL # replace this with the number
n_radiocarbon_ages <- NULL # replace this with the number
n_sites_with_radiocarbon_ages <- NULL # replace this with the number
...
We used `r n_radiocarbon_ages` radiocarbon ages to explore the temporal pattern of the function of stemmed points. We excluded assemblages that have no radiocarbon dates. We arranged `r n_sites_with_radiocarbon_ages` assemblages dated from 45ka to 14.8ka to explore variation in TCSA over time.
...
korean_archaeological_site_locations_tcsa <- 
  tcsa_site_ass %>% # maybe some sites are missing TSCA values in this table?
